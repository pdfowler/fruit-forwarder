...
- Make MCP reminder updates preserve omitted notes and due dates, while keeping
  explicit empty strings as clear operations.
- Add a reminder field behavior matrix covering supported fields, preservation,
...
- Require an explicit notarization-review acknowledgement before the protected
  GitHub release workflow can publish signed macOS artifacts.
